...
/**
 * Set by NavbarComponent on init so this plain util function can
 * start/resume smooth scrolling once the loading intro completes,
 * without needing Angular DI (this file is dynamically imported).
 */
let lenisStart: (() => void) | null = null;
export function registerLenisStart(fn: () => void): void {
  lenisStart = fn;
}
